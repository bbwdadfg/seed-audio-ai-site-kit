...
- Finished: pending Chocolatey review, Conda-forge CI/review, CRAN review/indexing, and Flathub review/tooling
...
| conda_forge | `submitted` | Conda-forge staged-recipes PR is open. A recipe patch was pushed in commit 67c24b9902 to fix the PyPI sdist license metadata build error; conda-forge CI rerun is pending. Mark verified only after feedstock or Anaconda package page exists. |
...
- conda_forge: Conda-forge staged-recipes PR is open. A recipe patch was pushed in commit 67c24b9902 to fix the PyPI sdist license metadata build error; conda-forge CI rerun is pending. Mark verified only after feedstock or Anaconda package page exists.
